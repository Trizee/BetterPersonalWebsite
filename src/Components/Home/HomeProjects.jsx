...
export default function HomeProjects(){
    ...
    return(
        ...
        >
            <img src={codehesive} className="h-14 w-14 rounded-full p-2 bg-darkGray ml-1" alt="Codehesive Icon" />
            <div>
        ...
        onClick={()=>nav('/projects/ecommerce')}>
            <img src={game} className="h-14 w-14 rounded-full p-2 bg-darkGray ml-1" alt="Store Icon" />
            <div>
